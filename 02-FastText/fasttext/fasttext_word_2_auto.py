...
model = fasttext.train_supervised(input=config.process_train_datapath_word,
                                  autotuneValidationFile=config.process_eval_datapath_word,
...
model_path = config.ft_model_save_path + '/model_word_2_auto.bin'
...
print(model.test(config.process_test_datapath_word))   # (4990, 0.7094188376753507, 0.7094188376753507)

print(model.test(config.process_eval_datapath_word))    #  (1997, 0.7200801201802705, 0.7200801201802705)